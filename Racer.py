...
def diffs(oldpossy):
    ...
    for booger, horsey in enumerate(u.possy):
        print(f'{str(booger + 1)}:', horsey, end=" ")
...
def race():
    ...
    print(
        'On this', u.weather['feel'] + ',', u.weather['sky'], f'{u.today}...'
    )
...
def clue():
    ...
    they = 'She' if u.someone == 'May Lee' else 'He'
    if u.met == 0:
        they = 'The person'
        someone = 'a person'
    ...
    if someone == 'a person':
        ...
        sh(2)
        print(f'\n     {they} asks: Have you got the answer yet?')
